...
def test_001_dummy_methods(settings, sample_project_settings):
    """
    Just directly test dummy methods
    """
    processor = SettingsPostProcessorTest()

    expand_result = processor._dummy_start(
    ...
    expand_result = processor._dummy_end1(
        sample_project_settings,
        "DUMMY_NAME",
        "I rule the"
    )
    ...
    expand_result = processor._dummy_end2(
        sample_project_settings,
        "DUMMY_NAME",
        "Hi"
    )
...
def test_002_chain_basic(settings, sample_project_settings):
    """
    Testing methods chaining on single rule
    """
    processor = SettingsPostProcessorTest()
...
def test_003_chain_more(settings, sample_project_settings):
    """
    Testing methods chaining with many rules
    """
    processor = SettingsPostProcessorTest()
...
def test_004_chain_order(settings, sample_project_settings):
    """
    Testing methods chaining order is respected
    """
    processor = SettingsPostProcessorTest()
...
def test_005_chain_empty(settings, sample_project_settings):
    """
    Testing methods chaining with no rules
    """
    processor = SettingsPostProcessorTest()
...
def test_006_chain_complete(settings, sample_project_settings):
    """
    Testing methods chaining on all fields
    """
    processor = SettingsPostProcessorTest()
