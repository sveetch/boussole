...
def test_conf_backend_base_filepath_ok_001(settings):
...
def test_conf_backend_base_filepath_ok_002(settings):
...
def test_conf_backend_base_filepath_error_001(settings):
...
def test_conf_backend_base_filepath_error_002(settings):
